...
CREATE PROCEDURE insert_audio_numeric_data(emr_id VARCHAR(255), assesmentDate DATE, value_numeric INT(11))
...
SET _concept_id=1263; Left ear at 1000Hz
-- SET _concept_id=1264; -- Left ear at 2000Hz
-- SET _concept_id=1265; -- Left ear at 4000Hz
-- SET _concept_id=1267; -- Left ear at 8000Hz
SET _parent_concept_id=1651; -- Left ear
-- SET _parent_concept_id=1652; -- Right ear
-- SET _concept_id=1274; -- Right ear at 8000Hz
-- SET _concept_id=1272; -- Right ear at 4000Hz
-- SET _concept_id=1271; -- Right ear at 2000Hz
-- SET _concept_id=1270; -- Right ear at 1000Hz
